...
const sendForgotPasswordPage = (req, res) => {
    res.render('pages/forgot-password.pug', { resetErrors: clientErrors.resetErrors })
...
const sendPasswordResetURL = async (req, res) => {
    ...
    const html5 = pug.renderFile(path.join(__dirname, "../", "../", "./client", "views", "modules", "email.pug"), {
    ...
    if (checkEmail) {
        ...
        clientErrors.resetErrors.emailExists = "Account With This Email Doesnt Exist"
